  ...
  public void controllerMenu() {
    ...
    while (true) {
      try {
        ...
        System.out.println("7. Find students by performance");
        System.out.println("8. View all students");
        System.out.println("9. Save all students to list");
        System.out.println("10. Load all students from list");
        System.out.println("11.Find students by Academic Performance: ");
        ...
        switch (choice) {
          ...
          case 6:
            ...
            break;
          case 7:
            System.out.println("Enter Performance of Student you want to find: ");
            listStudentBo.findStudentByPerformance();
//            listStudentBo.getStudentByRank("very good").forEach(System.out::println);
